...
# Unit tests only
test-unit:
	@bun test core/env.test.ts core/interval.test.ts core/invoke.test.ts core/log-rotator.test.ts core/watchdog.test.ts core/websocket.test.ts slack/channel.test.ts slack/spool-relay.test.ts agentmail/channel.test.ts linear/spool-relay.test.ts
